...
-- TRUNCATE(): 버림 후 소수점 오른쪽 자리수를 지정해 버림
...
-- FORMAT(): 반올림 후 자리수를 고정해 문자열로 출력 (쉼표를 넣어 보기좋게 출력)
SELECT FORMAT(5, 2), FORMAT(1234567.891, 2); -- 5.00, 1,234,567.89
